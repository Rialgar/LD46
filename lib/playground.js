...
(function() {
  ...
  window.playground = function playground(args) {
      ...
      for (var i = 0; i < gamepads.length; i++) {
        ...
        */
        ...
        for (var j = 0; j < buttons.length; j++) {
          ...
          previous.buttonValues[key] = buttons[j].value;
          ...
          if (buttons[j].pressed && !previous.buttons[key]) {
            ...
            this.gamepaddownEvent.value = buttons[j].value;
          ...
          if (buttons[j].pressed) {
            ...
            this.gamepadholdEvent.value = buttons[j].value;
          ...
          /* gamepad up */
            ...
            this.gamepadupEvent.value = buttons[j].value;
